		...
		<div class="popup_search">
			...
			<label for="popup_checkbox" class="popup_search_label">
				...
				<div class="info_content">
					Зарегистрированные члены клуба имеют <b>ключевую и бесплатную возможность</b> производить <b>автоматический поиск</b> запчастей и услуг по всему каталогу "Комтранс" и <b>получать персональные ответы от компаний</b>.<br><br>
					Стать членом клуба "Комтранс" очень просто! <br><br>

					Для этого достаточно ввести в форму ниже Ваши данные и подтвердить регистрацию по почте.
